					...
					<table class="table table-bordered table-striped" id="example1">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>Rp.<?php echo $isi['harga_jual']; ?></td>
									<!-- <td>
 										<?php if ($isi['stok'] == '0') { ?>
									...
									<td>Rp.<?php echo number_format($isi['harga_diskon']); ?>,-</td>
									<td>Rp.<?php echo number_format($isi['harga_diskon']); ?>,-</td>
									<td>Rp. <?php echo $isi['harga_jual'] * $isi['stok']; ?></td>
									<td>
										<?php if ($isi['stok'] <=  '3') { ?>
							...
							<?php
								$no++;
								$totalDiskon += $isi['harga_diskon'] * $isi['stok'];
								$totalJual += $isi['harga_jual'] * $isi['stok'];
								$totalAkhir = $totalJual - $totalDiskon;
								$totalStok += $isi['stok'];
							}
							?>
						</tbody>
						<tfoot>
							<tr>
								...
								<th></th>
								<th>Rp.<?php echo number_format($totalDiskon); ?>,-</td>
								<th></th>
								<th>Rp.<?php echo number_format($totalAkhir); ?>,-</td>
							...
							<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
								<div class="modal-body">
									...
									<table class="table table-striped bordered">
										...
										<tr>
											<td>Harga Diskon</td>
											<td><input type="number" placeholder="Harga Diskon" required class="form-control" name="diskon"></td>
										</tr>
										<tr>
											<td>Harga Jual</td>
